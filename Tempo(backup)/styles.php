...
<body id="top">
    ...
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="images/hero-bg.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=top>
        ...
        <ul class="home-sidelinks">
            <li><a href="index.php#about">About<span>who we are</span></a></li>
            <li><a href="index.php#services">Services<span>what we do</span></a></li>
            <li><a href="index.php#contact">Contact<span>get in touch</span></a></li>
